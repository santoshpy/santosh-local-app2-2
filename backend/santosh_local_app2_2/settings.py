"""
Django settings for santosh_local_app2_2 project.
...
ROOT_URLCONF = 'santosh_local_app2_2.urls'
...
WSGI_APPLICATION = 'santosh_local_app2_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "santosh-local-app2 Support <support@santosh-local-app2-2.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "santosh_local_app2_2 API",
    "DESCRIPTION": "API documentation for santosh_local_app2_2 App",
    "VERSION": "v1",
}
